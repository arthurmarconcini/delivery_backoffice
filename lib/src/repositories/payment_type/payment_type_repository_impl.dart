...
class PaymentTypesRepositoryImpl implements PaymentTypeRepository {
  final CustomDio _dio;

  PaymentTypesRepositoryImpl(this._dio);
  ...
  Future<PaymentTypeModel> getById(int id) async {
    try {
      ...
      throw RepositoryException(
          message: 'Error ao buscar forma de pagamento $id');
    }
  }
  ...
  Future<void> save(PaymentTypeModel model) async {
    try {
      ...
      throw RepositoryException(message: 'Error ao salvar forma de pagamento');
    }
  }
}
